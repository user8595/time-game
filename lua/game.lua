...
function gameUI()
  ...
  elseif buttonSkin == 2 then
    ...
    if state ~= "game" or isCountdown then
      ...
      love.graphics.setColor(1, 1, 1)
      love.graphics.draw(tex.button_2, gWidth / 2 - 25 + 20, 10 + buttonYOff + 20, 0, b2S, b2S,
        tex.button_2:getWidth() / 2, tex.button_2:getHeight() / 2)
    end
  ...
  love.graphics.setColor(white)
  love.graphics.printf({ tipCol, string.format("%.2f", speed) .. "x | " .. string.format("%.0f", bpm) .. " bpm" },
    font[2], 0, gHeight - 42, gWidth, "center")
...
function titleUI()
  ...
  if titleState == 1 then
    ...
    elseif titleSkin == 2 then
      ...
      love.graphics.setColor(1, 1, 1)
      love.graphics.draw(tex.button_2, gWidth / 2 - 3, 40 + 75, 0, Tb2S, Tb2S, tex.button_2:getWidth() / 2,
        tex.button_2:getHeight() / 2)
